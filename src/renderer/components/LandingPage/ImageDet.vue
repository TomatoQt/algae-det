<template>
  <div>
    <h2><i class="el-icon-picture"></i>&nbsp;单图片全检测</h2>
    <el-form ref="form" :model="form" label-width="100px">
      <el-form-item label="图片路径">
        <el-input v-model="form.name" class="path-area" :disabled="true"></el-input>
        <el-button type="primary" plain @click="getImagePath">选择图片</el-button>
...
export default {
  ...
  methods: {
    onSubmit(){
      ...
      this.start_det = true;
      this.$http.post(baseURL + '/detect_image', {path: path, conf_th: this.slider_value / 100, show_img: this.show_img})
          .then(response=>{
